...
if ( empty( $layout_site ) || ! in_array( $layout_site, array( 'boxed', 'boxed_narrow', 'wide' ) ) )
...
<script id='pixel-script-poptin' src='https://cdn.popt.in/pixel.js?id=8b9daed135bee' async='true'></script> 
	<?php wp_head(); ?>
<script type="text/javascript"> 
$("audio").each(function(){jQuery(this).append('controlsList="nodownload"')}); 
</script>
</head>
...
<div id="container">
	<div class="<?php echo esc_attr( str_replace( '_', '-', $layout_site ) ); ?>">
...
<?php echo do_shortcode('[pojo-sidebar id="46"]'); ?>
				<div class="container">
					<div class="logo">
